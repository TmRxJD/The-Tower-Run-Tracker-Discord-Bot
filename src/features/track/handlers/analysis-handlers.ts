...
const ANALYSIS_CHARTS: AnalysisChartDef[] = [
  ...
  { id: 'totalCells', label: 'Total Cells', category: 'Time & Progression', getYValue: r => toNum(r.totalCells ?? r.cells), color: '#42A5F5' },
  { id: 'totalDice', label: 'Total Dice', category: 'Time & Progression', getYValue: r => toNum(r.totalDice ?? r.rerollShards ?? r.dice), color: '#AB47BC' },
  // ── Economy ───────────────────────────────────────────────────────────────
  ...
  { id: 'cellsPerHour', label: 'Cells/Hr', category: 'Economy', getYValue: r => toNum(r.cellsPerHour) ?? perHour(r.totalCells ?? r.cells, r), color: '#42A5F5' },
  { id: 'dicePerHour', label: 'Dice/Hr', category: 'Economy', getYValue: r => toNum(r.rerollShardsPerHour ?? r.dicePerHour) ?? perHour(r.totalDice ?? r.rerollShards ?? r.dice, r), color: '#AB47BC' },
  { id: 'moduleShardsPerHour', label: 'Module Shards/Hr', category: 'Economy', getYValue: r => { const s = moduleShards(r); return s > 0 ? perHour(s, r) : null; }, color: '#FF8A65' },
  ...
  { id: 'rerollShardsFetched', label: 'Dice Fetched', category: 'Guardian', getYValue: r => toNum(r.rerollShardsFetched), color: '#AB47BC' },
  { id: 'cannonShardsFetched', label: 'Cannon Shards Fetched', category: 'Guardian', getYValue: r => toNum(r.cannonShardsFetched), color: '#FF8A65' },
  { id: 'armorShardsFetched', label: 'Armor Shards Fetched', category: 'Guardian', getYValue: r => toNum(r.armorShardsFetched), color: '#29B6F6' },
  { id: 'generatorShardsFetched', label: 'Generator Shards Fetched', category: 'Guardian', getYValue: r => toNum(r.generatorShardsFetched), color: '#66BB6A' },
  { id: 'coreShardsFetched', label: 'Core Shards Fetched', category: 'Guardian', getYValue: r => toNum(r.coreShardsFetched), color: '#F48FB1' },
  // ── Coverage ──────────────────────────────────────────────────────────────
